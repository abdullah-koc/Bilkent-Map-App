...
public class SliderAdapterStarbucksA extends PagerAdapter {

    Context context;
    LayoutInflater layoutInflater;

    public SliderAdapterStarbucksA(Context context){
    ...
    public String[] texts = {
            "Bina girişinden sağa dönün ve yolu takip edin.",
            "Starbucks yolun sonundadır."
    };
