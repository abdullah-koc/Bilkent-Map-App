...
public class SliderAdapterFieroG extends PagerAdapter {

    Context context;
    LayoutInflater layoutInflater;

    public SliderAdapterFieroG(Context context){
    ...
    public String[] texts = {
            "G binasının eğitim fakültesi girişine gidin (Mescid-Yemekhane arasında)",
            "Fiero giriştedir."
    };
