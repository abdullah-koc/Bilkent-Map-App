...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener {
    ...
    private String             buildingName, x;
    private NavigationView     navigationView;
    private static final int CHECK_FREQ = 5000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Lütfen bekleyiniz", Toast.LENGTH_LONG).show();
        Toast.makeText(this, "Lütfen bekleyiniz", Toast.LENGTH_LONG).show();

        switch2 = findViewById(R.id.switch2);
         x = DirectionsCriteria.PROFILE_WALKING;
         switch2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
             @Override
             public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                 if(isChecked){
                     x = DirectionsCriteria.PROFILE_DRIVING;
                     Toast.makeText(getApplicationContext(), "Lütfen bekleyiniz", Toast.LENGTH_SHORT).show();
                 }
                 else{
                     x = DirectionsCriteria.PROFILE_WALKING;
                     Toast.makeText(getApplicationContext(), "Lütfen bekleyiniz", Toast.LENGTH_SHORT).show();
         ...
         newLocation = Point.fromLngLat(32.748854, 39.867867);
        ...
        handler2.postDelayed(() -> {
            Runnable r = new Runnable() {
                ...
                public void run() {
                    ...
                    newLocation = Point.fromLngLat(locationComponent.getLastKnownLocation().getLongitude(),locationComponent.getLastKnownLocation().getLatitude());
                    ...
                    if( buildingName.equals("B")) {
                        ...
                        if(newLocation.latitude() > 39.8685 && newLocation.latitude() < 39.8690 && newLocation.longitude() > 32.7475 && newLocation.longitude() < 32.7485) {
                            Toast.makeText(MapActivity.this, "Hedefe ulaştınız!", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
            ...
            handler.postDelayed(r,CHECK_FREQ);
        }, 3000);
        ...
        buttonGo2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(buildingName.equals("FameoEA") || buildingName.equals("MozartB") || buildingName.equals("MozartD") || buildingName.equals("MozartEE")
                        ...
                        || buildingName.equals("CBlokAmfi") || buildingName.equals("Lab") || buildingName.equals("FieroG") || buildingName.equals("Rektorluk")){
                    ...
                    if(buildingName.equals("Rektorluk")){ intent2.putExtra("building", "Rektorluk");}
    ...
    private void getRoute(Point origin, Point destination) {
        NavigationRoute.builder(this).accessToken(Mapbox.getAccessToken()).origin(origin).destination(destination)
                .profile(x).build().getRoute(new Callback<DirectionsResponse>() {      // walking routes
            @Override
    ...
    public boolean mapTracker ( Point newLocation, double longitude, double latitude, double smallLongitude, double bigLongitude, double smallLatitude, double bigLatitude )
    {
        ...
        {
            Toast.makeText( MapActivity.this, "Hedefe ulaştınız!", Toast.LENGTH_LONG).show();
            return true;
        }
        return false;
    }
