...
public class SliderAdapterRektorluk extends PagerAdapter {

    Context context;
    LayoutInflater layoutInflater;

    public SliderAdapterRektorluk(Context context){
    ...
    public String[] texts = {
            "EA binasına girin.",
            "Rektörlük ile alakalı birimler G- kodlu odalardadır. (G-24 >> Rektörlük odası)"
    };
