...
public class SliderAdapterMozartB extends PagerAdapter {

    Context context;
    LayoutInflater layoutInflater;

    public SliderAdapterMozartB( Context context){
    ...
    public String[] texts = {
            "Merdivenler veya asansör ile giriş katından 1 kat aşağı inin.",
            "Mozart Cafe sol taraftadır."
    };
